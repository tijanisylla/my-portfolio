...
const Contact: React.FC = () => {
  ...
  const serviceId: string = process.env.REACT_APP_MY_SERVICE_ID;
  const templateId: string = process.env.REACT_APP_MY_TEMPLATE_ID;
  const publicKey: string = process.env.REACT_APP_MY_PUBLIC_KEY;
